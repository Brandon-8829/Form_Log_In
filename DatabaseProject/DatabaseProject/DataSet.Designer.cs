...
namespace DatabaseProject {
    ...
    public partial class DataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public UsersRow AddUsersRow(int ID, string Name, string Email, string Password, string Country) {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Users] WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Na" +
                "me) AND ([Email] = @Original_Email) AND ([Password] = @Original_Password) AND ([" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([ID], [Name], [Email], [Password], [Country]) VALUES (" +
                "@ID, @Name, @Email, @Password, @Country);\r\nSELECT ID, Name, Email, Password, Cou" +
                "ntry FROM Users WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [ID] = @ID, [Name] = @Name, [Email] = @Email, [Password] = @Password, [Country] = @Country WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Name) AND ([Email] = @Original_Email) AND ([Password] = @Original_Password) AND ([Country] = @Original_Country));
SELECT ID, Name, Email, Password, Country FROM Users WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Email, Password, Country FROM dbo.Users";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "INSERT INTO [dbo].[Users] ([ID], [Name], [Email], [Password], [Country]) VALUES (" +
                "@ID, @Name, @Email, @Password, @Country);\r\nSELECT ID, Name, Email, Password, Cou" +
                "ntry FROM Users WHERE (ID = @ID)";
        ...
        public virtual int Delete(int Original_ID, string Original_Name, string Original_Email, string Original_Password, string Original_Country) {
        ...
        public virtual int Insert(int ID, string Name, string Email, string Password, string Country) {
        ...
        public virtual int Update(int ID, string Name, string Email, string Password, string Country, int Original_ID, string Original_Name, string Original_Email, string Original_Password, string Original_Country) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Email, string Password, string Country, int Original_ID, string Original_Name, string Original_Email, string Original_Password, string Original_Country) {
            return this.Update(Original_ID, Name, Email, Password, Country, Original_ID, Original_Name, Original_Email, Original_Password, Original_Country);
        }
        ...
        public virtual int InsertQuery(int ID, string Name, string Email, string Password, string Country) {
